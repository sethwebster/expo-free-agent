          ...
          <h1 className="text-7xl md:text-9xl lg:text-[10rem] font-bold tracking-tighter mb-8 leading-[0.85] text-zinc-900 dark:text-white drop-shadow-sm flex flex-col items-center">
            ...
            <span className="flex items-center justify-center mt-2">
              {"Unlimited.".split("").map((char, i) => (
                ...
                >
                  <span
                    className="inline-block animate-letter-rise bg-clip-text text-transparent pb-4 bg-[linear-gradient(8deg,#18181b_0%,#6366f1_50%,#18181b_100%)] dark:bg-[linear-gradient(8deg,#ffffff_0%,#818cf8_50%,#ffffff_100%)]"
                    style={{
    ...
    <div ref={containerRef} className="col-span-1 md:col-span-3 h-[350vh] relative pointer-events-none">
      <div className="sticky top-0 h-screen w-full flex flex-col items-center">
        ...
        >
          ...
          {/* Card Text Content */}
          <div className="absolute inset-0 z-10 flex flex-col justify-end items-center pb-24 pointer-events-none p-6 text-center">
            <h3
            ...
            <p className="text-zinc-400 text-lg md:text-xl max-w-lg mb-8 transition-opacity duration-300" style={{ opacity: animState < 0.5 ? 1 : 0.7 }}>
              {animState > 0.8 ? "Drag to rotate view." : "No cloud bills. Pure peer-to-peer power."}
            </p>
          </div>
        </div>
      </div>
