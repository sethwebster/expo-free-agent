...
function Hero() {
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      // Track scroll progress for camera movement
      setScrollProgress(scrollY / viewportHeight);
    };
  ...
  return (
    <section className="relative h-screen flex flex-col justify-center overflow-hidden">
      ...
      {/* Content */}
      <div className="relative max-w-[1200px] mx-auto text-center w-full z-10 px-6 pt-20 pointer-events-none">
