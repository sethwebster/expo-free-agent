...
public class TartVMManager {
    ...
    public init(configuration: VMConfiguration, templateImage: String = "ghcr.io/sethwebster/expo-free-agent-base:0.1.16", vmUser: String = "admin", tartPath: String = "/opt/homebrew/bin/tart") {
